...
const FeaturedProducts = ({type}) => {
  ...
  return (
    <div className='featuredProducts'>
      <div className="top">
        <h1>{type} products</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis molestias dolores placeat, dicta, eos, harum voluptates magnam eaque recusandae consequatur doloremque repudiandae veritatis eius reprehenderit tenetur? Ipsa excepturi nulla cupiditate!</p>
      </div>
